...
sys.path.append('/mnt/f/ScanCraft')
...
free=scan(method='mcmc')
# Lambda,Kappa,A_Lambda,A_Kappa,mu,tanBeta,A_t
free.AddScalar('tanB','MINPAR',3,1.,60.)

# setup SPheno controller
S=SPheno()

# get values from SPheno input file
free.GetValue('/mnt/f/ScanCraft/command/nexus/packages/SPheno_4.0.3/LesHouches.in.NMSSM_lowmel')
...
while record_number < target_number:
    ...
    spectr=S.Run(newpoint) # Modified by Mel
